...
PRIME_INITIAL_VALUE = 0.03
INITIAL_STEADY_PERIOD_MONTHS_DURATION = 12
STEADY_RAMP_MONTHS_DURATION = 84
LONG_RANGE_CENTERLINE = 0.03
BANKS_MARGINE = 0.015
PRIME_ADDED_YEARLY_RATE = 0#-0.0064

max_monthly_payment = lambda asset_cost, capital: (asset_cost - capital) * 2 / (30 * 12)


PARAMETER_LANG_MAP = {
    'he':{
        'tabs': ['חישוב אוטומטי', 'מידע על משתני החישוב'], # 'אודות הפרוייקט'],
        'input_titles': {
            'guide': {'button': 'ⓘ מדריך',
        ...
        'waiver':
            ...
            f'<center><a href="http://linkedin.com/in/natanel-davidovits-28695312" target="_blank" rel="noopener"> {"נתנאל דוידוביץ"} </a></center>'
        ,
    ...
    'en':{
        'tabs': ['Automatic calculation', 'Calculation parameters information'], #'About this project'],
        'input_titles': {
            'guide': {'button': 'ⓘ Guide',
        ...
        'waiver':
            ...
            f'<center><a href="http://linkedin.com/in/natanel-davidovits-28695312" target="_blank" rel="noopener"> {"Natanel Davidovits"} </a></center>'
        ,
